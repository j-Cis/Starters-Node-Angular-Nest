...
module.exports = {
    ...
    output: {
        path: resolve('./packages/D-webpack-nest-angular-static/build/rs/client/'),
        filename: '[name].js',
    },
    ...
    plugins: [
        ...
        new AngularCompilerPlugin({
            ...
            hostReplacementPaths: {
                [resolve('./packages/D-webpack-nest-angular-static/client/src/environments/environment.ts')]: resolve('./packages/D-webpack-nest-angular-static/client/src/environments/environment.prod.ts')
            }
        }),
